...
- 購入制限: 以下の条件を満たさない場合、購入ボタンを非活性（disabled）とする。
- 単勝/複勝：Col1に1つ以上のチェック。
- 2連系（馬連等）：Col1とCol2の両方に1つ以上のチェック、かつ有効な組み合わせが1点以上存在。
- 3連系：Col1, Col2, Col3の全てに1つ以上のチェック、かつ有効な組み合わせが1点以上存在。
